...
?>
<article class="reservation-row reservation-row-host<?= $isUnread ? ' is-unread' : '' ?>" data-booking-id="<?= $bookingId ?>" data-booking-tab="<?= e($tab) ?>">
    <a href="<?= e($detailUrl) ?>" class="reservation-row-link">
        ...
        <div class="reservation-row-body">
            ...
            <p class="reservation-row-meta"><?= e(__('reservations.host.guest')) ?> · <?= e($guestName) ?></p>
